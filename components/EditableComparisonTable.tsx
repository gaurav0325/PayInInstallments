  ...
  const [rows, setRows] = useState<ComparisonRow[]>([
    {
      ...
      risk: 'High - Test Airlines carries all risk',
      ...
      cx: 'Excellent - Native Test Airlines experience',
    ...
    },
    {
      ...
      fraudAndDS: 'Partner + Test Airlines coordination',
    ...
    },
    {
      ...
      risk: 'Medium - Test Airlines bears remaining payment risk',
    ...
    },
    {
      ...
      fees: 'No fees to Test Airlines',
      refund: 'Standard Test Airlines policies apply',
    ...
    },
    {
      ...
      refund: 'Standard Test Airlines policies',
      ...
      additionalFees: 'None from Test Airlines perspective',
      threeRI: 'Not applicable',
      priority: 'low',
      order: 9
    },
    ...
    },
    {
      ...
      risk: 'High - Test Airlines inventory + payment risk',
      complexity: 'High - New system development',
      flexibility: 'Very High - Test Airlines controlled terms',
      fees: 'Hold fees + standard processing',
      refund: 'Test Airlines managed - Hold cancellation',
      ledgerAccounting: 'Complex - Inventory + payment tracking',
      cx: 'Excellent - Native Test Airlines system',
